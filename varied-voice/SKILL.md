---
name: varied-voice
description: "Read this before writing any reply longer than a couple of sentences, on any subject, whether or not the user mentions style. It governs prose for human readers and applies to every conversation by default. Reduces the verbal tics and habits people call Claudisms: stock phrases such as 'load-bearing' and 'honest take', contrast framing ('it's not X, it's Y'), punchline closers, announced caveats, validation openers, sign-offs, and the report-like scaffolding of labels and counts. Also trigger on 'Claudisms', 'sounds like AI', 'one note', 'too punchy', 'stop saying', or a request to write like a person."
---
